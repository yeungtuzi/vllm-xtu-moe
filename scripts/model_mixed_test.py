...
MODEL = os.environ.get("TEST_MODEL", "/home/user/.cache/modelscope/models/zai-org/GLM-5.3-Flash")
...
def main() -> int:
    ...
    llm = LLM(
        ...
        skip_tokenizer_init=(os.environ.get("SKIP_TOK","1")=="1"),
    ...
    if os.environ.get("SKIP_TOK","1")=="1":
        prompts = [{"prompt_token_ids": [100, 200, 300, 400]}]
    else:
        prompts = [os.environ.get("PROMPT", "The capital of France is")]
    ...
    print(f"[glm] text: {out[0].outputs[0].text[:120]!r}", flush=True)
