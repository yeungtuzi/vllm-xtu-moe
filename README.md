...
| **MiMo-V2.6-Flash-RL**<br>TP=2 · util 0.85 · **MAXLEN 1048576**<br>MBT 4096 · **MTP k=1** · 多模态关 | 长 | 16,384 | 1 | **302.5** | **26.7** |
| | 长 | 16,384 | 2 | **326.9** | **53.4** |

GLM / DeepSeek-V4.1 未开投机解码（random 数据集对投机是最坏情况，且会挤占长上下文的显存）；**MiMo-V2.6 开了 MTP k=1**，其 **short 行待测**，其余格子均为同一批实测。
