...
| **MiMo-V2.6-Flash-RL**<br>TP=2 · util 0.85 · **MAXLEN 131072**<br>MBT 8192 · **MTP k=1** · **GPU 预填开(门槛 4096)** · 含形状预热 | 短 | 128 | 1 | **238.1** | **31.7** |
| | 短 | 128 | 2 | 57.5 ⚠️ | **62.9** |
| | 长 | 16,384 | 1 | **726.1** | **28.1** |
| | 长 | 16,384 | 2 | **723.8** | **54.3** |
...
> ⚠️ **短上下文 C=2 的 prefill(57.5)是已知异常的实测值** —— 128-token 的 prompt 在 C=2 下 TTFT 会从 ~0.5 s 跳到 ~4.5 s；该现象在 DS-V4.1 与 MiMo 上都复现，原因待查（见 `docs/EXPERIMENTS.md` B116/B120）。其余格子均为同一批实测。
