...
|---|---|---|---|---|---|
| **GLM-5.3-Flash**<br>TP=2 · util 0.82 · GPU 预填充<br>KV 池封顶 2 GiB · MBT 4096 | 短 | 126 | 1 | 110.1 | **23.0** |
| | 短 | 126 | 4 | 60.4 | 7.3 |
| | 长 | 4,918 | 1 | **207.1** | 21.6 |
| | 长 | 4,918 | 4 | 158.5 | 2.8 |
| **MiMo-V2.5**<br>单卡 · maxlen 16K · KV 封顶 4 GiB<br>MTP k=1 · GPU 预填充 | 短 | 153 | 1 | 70.9 | **18.0** |
| | 短 | 153 | 4 | 59.9 | 6.0 |
| | 长 | 4,148 | 1 | 179.1 | 17.4 |
| | 长 | 4,148 | 4 | **1,844.8** | 6.4 |
| **DeepSeek-V4.1-Flash**<br>TP=2 · dspark k=5 · GPU 预填充 | 短 | ~114 | 1 / 4 | 测量中 | 测量中 |
| | 长 | ~4,479 | 1 / 4 | 测量中 | 测量中 |
...
2. **合批能再抬一个数量级**:MiMo 同一长 prompt,**C=1 179 → C=4 1,845 tok/s(+10×)** ——
   4 路并发把 16,592 token 合成大批,同一份权重搬运费摊到 4 倍的 token 上。
   **这也解释了为什么短 prompt 看着"慢"**:126 tok 的活儿,固定开销占了大头。
