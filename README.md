...
|---|---|---|---|---|---|
| **GLM-5.3-Flash**<br>TP=2 · util 0.82 · GPU 预填充<br>KV 池封顶 2 GiB · MBT 4096 · MTP 关 | 短 | 140 | 1 | **115.2** | **22.0** |
| | 短 | 140 | 2 | **70.4** | 13.9 |
| | 长 | 16,396 | 1 | **155.3** | **21.5** |
| | 长 | 16,396 | 2 | **119.5** | 1.7 |
| **MiMo-V2.5**<br>单卡 · maxlen 20K · KV 封顶 8.5 GiB<br>MTP k=1 · GPU 预填充 | 短 | 152 | 1 | **64.2** | **16.7** |
| | 短 | 152 | 2 | **48.1** | 9.6 |
| | 长 | — | 1 | 待测 † | 待测 † |
| | 长 | — | 2 | 待测 † | 待测 † |
| **DeepSeek-V4.1-Flash**<br>TP=2 · dspark k=5 · GPU 预填充<br>KV 封顶 1.0 GiB · MBT 16384 | 短 | 128 | 1 | **254.3** | **19.8** |
| | 短 | 128 | 2 | **175.2** | 14.0 |
| | 长 | — | 1 | 待测 † | 待测 † |
| | 长 | — | 2 | 待测 † | 待测 † |

> † **长 prompt 的 4 格尚未取得**：两个模型都在长 prompt 上撞到**显存预算**问题
> （MiMo 是我给的 KV cap 过宽导致 OOM；DeepSeek-V4.1 是装配期的 `aten::new_empty` 分配失败），
> 与已修复的 GLM 旁路流非法访存**不是同一个根因**。诊断见
> `dev-docs/RND_CAMPAIGN_DIAGNOSIS.md` §18/§19，配置与预算方法见 `docs/TUNING_GUIDE.md`。
